...
=== 회원 팔로우 목록 조회
.curl-request
include::{snippets}/get-follow-members/curl-request.adoc[]
...
=== 회원 프로필 사진 등록
.curl-request
include::{snippets}/post-member-profile/curl-request.adoc[]
...
=== 회원 팔로우/언팔로우
.curl-request
include::{snippets}/post-member-follow/curl-request.adoc[]
...
=== 액세스 토큰 상태 조회
.curl-request
include::{snippets}/auth-jwt-test/curl-request.adoc[]
