...
class AuthControllerSliceTest {
    ...
    void loginTest() throws Exception {
        // Given
        LoginRequest loginDto = new LoginRequest("email@com", "qwe123!@#");
    ...
    void loginFailedTest_Password() throws Exception {
        // Given
        LoginRequest loginDto = new LoginRequest("email@com", "wrongPassword");
        String content = gson.toJson(loginDto);
    ...
    void loginFailedTest_Account() throws Exception {
        // Given
        LoginRequest loginDto = new LoginRequest("none@com", "qwe123!@#");
        String content = gson.toJson(loginDto);
